...
class ApplicationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "district": forms.Select(attrs={'class': 'form-control bg-transparent border-primary p-3'}),
            "text": forms.TextInput(attrs={'class': 'form-control'}),
            "hujumturi": forms.Select(attrs={'class': 'form-control bg-transparent border-primary p-3 bi bi-arrow-right', 'id': 'id_hujumturi', 'onchange': 'showDiv(this)'}),
